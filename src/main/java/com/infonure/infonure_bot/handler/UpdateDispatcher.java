...
public class UpdateDispatcher {
    ...
    private void handleTimetableCommand(Message message, List<BotApiMethod<?>> responses) {
        ...
        else if (groupCode.isEmpty() || groupCode.get().trim().isEmpty() || groupCode.get().equals("null")) responses.add(messageFactory.createMessage(chatId, "Будь ласка, спочатку оберіть групу:\nОсобиста: /group\nДля чату (адмін): /set_chat_group"));
